...
// Declare the delay function implemented in assembly
extern void a_delay(uint32_t ulCount);
...
//    a_delay(16666667);                    // delay ~1 sec at 50 MHz
...
//  }
  ...
  Nokia5110_OutString("************* LCD Test *************");
	Nokia5110_OutString("Letter: Num:------- ---- ");
  ...
  while(1){
    ...
    a_delay(5333333);                     // delay ~0.5 sec at 50 MHz
    count = count + 1;
  }
}
